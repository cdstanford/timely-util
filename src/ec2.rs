...
use crate::util::network_util::barrier;
...
pub fn get_ec2_node_number() -> u64 {
    ...
    file_util::match_line_in_file(&ipv4, EC2_IP_FILE).unwrap_or_else(|err| {
        panic!(
...
pub fn prepare_ec2_host_file(port: u64) -> &'static str {
    file_util::replace_lines_in_file(
        EC2_IP_FILE,
        EC2_HOST_TEMP_FILE,
...
pub fn ec2_barrier(num_nodes: u64, this_node: u64, start_port: u16) {
    let host0 = file_util::first_line_in_file(EC2_IP_FILE);
